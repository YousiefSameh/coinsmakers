  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div className="checkout-address flex-1" variants={formVariants}>
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            <motion.form
              ...
              className="checkout-address-input mt-2.5 flex justify-between items-center dark:bg-[#272B3A] rounded-sm"
