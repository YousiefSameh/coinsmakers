	...
	({ title, imgSrc, bgColor, onClick }: WithdrawCardProps) => (
		<>
			<div
				...
				className={`card relative p-0 md:p-3 flex items-center justify-center min-w-[6rem] md:min-w-[10rem] min-h-[13rem] flex-col hover:scale-105 transform transition duration-300 ${bgColor} group`}
			>
